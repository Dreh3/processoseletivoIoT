...
#Função de interrupção do botão, acionada quando o botão é pressionado ou solto
def interrupcaoBotao(pin):
  global PORTA_ABERTA, ESTADO_DE_ERRO_PORTA
...
btn1.irq(trigger=Pin.IRQ_FALLING | Pin.IRQ_RISING , handler=interrupcaoBotao)
